...
glm::vec4 Colour::convertToNormalizedColour()
{
	glm::vec4 newColour;

	newColour.r = (float)this->r / 255;
	newColour.g = (float)this->g / 255;
	newColour.b = (float)this->b / 255;
	newColour.a = (float)this->a / 255;
